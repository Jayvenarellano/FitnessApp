    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Arm2.this, Men3.class);
                startActivity(intent);

            }
        });

        textView=(TextView)findViewById(R.id.armarrow3);
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arm2.this, Arm1.class);
                startActivity(intent);
            }
        });
        textView=(TextView)findViewById(R.id.armarrow4);
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arm2.this, Arm3.class);
                startActivity(intent);
            }
        });
        ...
        Chestbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arm2.this, ChestReady1.class);
                startActivity(intent);
