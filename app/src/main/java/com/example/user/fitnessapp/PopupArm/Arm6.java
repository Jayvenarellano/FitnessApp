...
public class Arm6 extends AppCompatActivity {
    TextView textView;
    Button Chestbtn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_arm6);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Arm6.this, Men3.class);
                startActivity(intent);

            }
        });
        textView=(TextView)findViewById(R.id.armarrow11);
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arm6.this, Arm5.class);
                startActivity(intent);
            }
        });
        ...
        Chestbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arm6.this, ChestReady1.class);
                startActivity(intent);
