...
public class Popupwindow1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button) findViewById(R.id.AbsStart1);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Popupwindow1.this, Men1.class);
                startActivity(intent);

            }
        });
        textView=(TextView)findViewById(R.id.arrow2);
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Popupwindow1.this, Popupwindow2.class);
                startActivity(intent);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Popupwindow1.this, AbsReady1.class);
                startActivity(intent);
