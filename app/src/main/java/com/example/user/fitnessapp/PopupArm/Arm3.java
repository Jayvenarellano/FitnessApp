...
public class Arm3 extends AppCompatActivity {
    TextView textView;
    Button Chestbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Arm3.this, Men3.class);
                startActivity(intent);

            }
        });
        textView=(TextView)findViewById(R.id.armarrow5);
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arm3.this, Arm2.class);
                startActivity(intent);
            }
        });
        textView=(TextView)findViewById(R.id.armarrow6);
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arm3.this, Arm4.class);
                startActivity(intent);
            }
        });
        ...
        Chestbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Arm3.this, ChestReady1.class);
                startActivity(intent);
