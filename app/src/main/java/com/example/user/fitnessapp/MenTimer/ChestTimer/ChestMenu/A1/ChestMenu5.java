...
public class ChestMenu5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chest_menu5);

        ChestBtn5 = (CardView) findViewById(R.id.ChestBtn1);
        ChestBtns5 = (CardView) findViewById(R.id.ChestBtns1);
